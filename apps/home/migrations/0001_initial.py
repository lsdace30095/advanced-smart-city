# Generated by Django 4.1.3 on 2023-02-23 07:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_bin', models.FileField(storage=django.core.files.storage.FileSystemStorage(location=pathlib.PurePosixPath('/app/media')), upload_to='models/')),
                ('model_xml', models.FileField(storage=django.core.files.storage.FileSystemStorage(location=pathlib.PurePosixPath('/app/media')), upload_to='models/')),
